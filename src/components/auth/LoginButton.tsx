...
export const LoginButton: React.FC = () => {
  ...
  if (loading) {
    return (
      <button disabled className="px-4 py-2 bg-gray-200 text-gray-500 rounded-md font-medium">
        Loading...
      </button>
    );
  }
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 px-4 py-2 bg-white text-gray-900 rounded-md font-medium hover:bg-gray-100 transition-colors shadow-sm"
    >
